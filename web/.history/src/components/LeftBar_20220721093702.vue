<template>
    <div class="leftbar">
        ...
        <div class="footer">
            <button class="footerbox" @click="changePage(0)">HOME</button>
            <button class="footerbox" @click="changePage(1)">ABOUT</button>
            <button class="footerbox" @click="changePage(2)">INFO</button>
        </div>
    </div>
</template>
