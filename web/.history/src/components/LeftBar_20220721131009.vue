<template>
    <div class="leftbar">
        ...
        <div class="icon1">
            ...
            <a href="https://space.bilibili.com/470249/" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <!-- </div> -->
            <!-- <div> -->
            <a href="https://weibo.com/u/1781729755" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                    <path fill="#ff3d23"
        ...
        <div class="footer">
            ...
            <button class="footerbox" @click="changePage(1)" :class="isThisPage(1) ? 'active' : ``">ABOUT</button>
            <button class="footerbox" @click="changePage(2)" :class="isThisPage(2) ? 'active' : ``">INFO</button>
        </div>
    </div>
</template>
