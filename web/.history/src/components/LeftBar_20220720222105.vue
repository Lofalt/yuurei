<template>
    <div class="leftbar">
        ...
        <div class="icon">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="2em" height="2em"
                viewBox="0 0 512 512">
                <path fill="#888888"
        ...
        <div class="footer">
            <button class="footerbox" @click="about">HOME</button>
            <button class="footerbox" @click="home">ABOUT</button>
            <button class="footerbox">INFO</button>
        </div>
    </div>
</template>
