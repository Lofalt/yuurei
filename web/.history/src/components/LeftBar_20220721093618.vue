<template>
    <div class="leftbar">
        ...
        <div class="footer">
            <button class="footerbox" @click="changePage">HOME</button>
            <button class="footerbox" @click="changePage">ABOUT</button>
            <button class="footerbox" @click="changePage">INFO</button>
        </div>
    </div>
</template>
