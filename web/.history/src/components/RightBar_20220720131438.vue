<template>
    <div class="rightbar" @click="pushCard">
        <div class="showpage">
            <div class="showtag tag1" @click.prevent="pullCard(0)"></div>
            <router-view></router-view>
        </div>
        <div class="showpage">
            <div class="showtag tag2" @click.prevent="pullCard(1)"></div>
            <router-view></router-view>
        </div>
        <div class="showpage">
            <div class="showtag tag3" @click.prevent="pullCard(2)"></div>
            <router-view></router-view>
        </div>
        <div class="showpage">
            <div class="showtag tag4" @click.prevent="pullCard(3)"></div>
            <router-view></router-view>
        </div>
    </div>
</template>
