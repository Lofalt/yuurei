...
function change() {
  ...
  actualCard.style.transition = "all 1s ease"
  actualCard.style.transform = "translateY(-1000px)"
  // actualCard.style.transition = ""
  const card2 = document.getElementsByClassName("buttom") as HTMLSelectElement
  const actualCard2 = card[0]
  actualCard.style.transition = "all 1s ease"
