<template>
    <div class="container">
        ...
        <button @click="showModal = true">点我</button>
        <n-modal v-model:show="showModal" :to="container" :display-directive="'show'" :transform-origin="'mouse'">
            <n-card size="huge" aria-modal="true" style="width: 600px; position: absolute; left: 100px; bottom: 100px">
