...
<template>
    <div class='limit-box'>
        <!--  -->
        <v3-waterfall class="waterfall" :list="list" srcKey="cover" :gap="12" :colWidth="280" :distanceToScroll="200"
            scrollBodySelector='.limit-box' :isMounted="isMounted" :isLoading="loading" :isOver="over"
