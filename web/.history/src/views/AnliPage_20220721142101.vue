...
<template>
    <v3-waterfall scrollBodySelector=".father-box" :isMounted="isMounted" class=" waterfall" :list="list" srcKey="cover"
        :gap="10" :colWidth="280" :distanceToScroll="100" :isLoading="loading" :isOver="over"
