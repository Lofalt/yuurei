  ...
  function waterFall() {
      setTimeout(() => {
          ...
          let childs = document.getElementsByClassName("test")
          ...
          for (let i = 0; i < childs.length; i++) {
              ...
              if (i < col) {
                  ...
                  console.log(heightArr, boxHeight, minBoxHeight, minIndex)
                  minBoxHeight = heightArr[this.minBox(heightArr)]
                  minIndex = this.minBox(heightArr)
                  childs[i].style.position = 'absolute'
  ...
  minBox(box) {
      ...
      watch: {
          'screenWidth'() {
              ...
              else if (this.screenWidth < 1000 && this.screenWidth >= 700) {
                  this.col = 3
          ...
          'col'() {
              let childs = document.getElementsByClassName("test")
              for (let i = 0; i < childs.length; i++) {
                  childs[i].style.width = 100 / this.col + "%"
              }
              this.waterFall()
