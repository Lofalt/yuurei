<template>
    <div class="container" @click.self="showModal = false">
        ...
        <n-modal v-model:show="showTheModal" v-show="showTheModal" :display-directive="'show'"
...
function changeModal() {
    if (document.body.clientWidth > 1024) {
        showModal.value = !showModal.valu
    }
    else {
...
const showTheModal = computed(() => {
    console.log(document.body.clientWidth)
    return showModal.value && document.body.clientWidth < 1024
})
