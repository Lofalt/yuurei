...
<template>
    <v3-waterfall class="waterfall" :list="list" srcKey="cover" :gap="10" :colWidth="280" :distanceToScroll="100"
        :isLoading="loading" :isOver="over" @scrollReachBottom="getNext" :dotsNum="3">
