<template>
    <div id="main" @wheel="listenScroll" @click.stop="zoomout">
    ...
    <div v-show="hover" class="photoInfo" :style="{ backgroundImage: `url('` + showingPage + `')` }">
...
function zoom(event: number) {
    ...
    showingPage.value = childs[index].getAttribute("src") as string
    hover.value = true
    // let childs = document.getElementsByClassName("test") as HTMLSelectElement
